from solid2.core.builtins.primitives import OpenSCADObjectPlus
from solid2.core import cube, difference, union
from solid2.core.object_base import ObjectBase
from solid2.extensions.bosl2 import cuboid

from .assembly import Assembly
from ..dimensions import RackDims, RackScrewDims, ShelfTabDims
import math


class FacePlate(Assembly):
    """
    ...
    def __init__(self, 
        ...
        self.rib_size: list[float] = rib_size
        self.part = part
    ...
    def render(self) -> ObjectBase:
        ...
        part_area_size = [
            plate_size[0] - 2*ShelfTabDims.WIDTH_TECMOJO - 2*self.rib_size[0], 
            plate_size[1] - 2*self.rib_size[0], 
            self.thickness
        ]        
        return cube(plate_size)
